...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@skpm/timers/timeout.js */ "./node_modules/@skpm/timers/timeout.js")["setTimeout"], __webpack_require__(/*! ./node_modules/@skpm/timers/timeout.js */ "./node_modules/@skpm/timers/timeout.js")["clearTimeout"], __webpack_require__(/*! ./node_modules/promise-polyfill/lib/index.js */ "./node_modules/promise-polyfill/lib/index.js"), __webpack_require__(/*! ./node_modules/@skpm/timers/interval.js */ "./node_modules/@skpm/timers/interval.js")["setInterval"], __webpack_require__(/*! ./node_modules/@skpm/timers/interval.js */ "./node_modules/@skpm/timers/interval.js")["clearInterval"]))
...
var csv = __webpack_require__(/*! csvtojson */ "./node_modules/csvtojson/browser/browser.js"); // documentation: https://developer.sketchapp.com/reference/api/
// inspiration: https://github.com/DWilliames/Google-sheets-content-sync-sketch-plugin/blob/master/Google%20sheets%20content%20sync.sketchplugin/Contents/Sketch/main.js


/* harmony default export */ __webpack_exports__["default"] = (function () {
  var contentFileName = 'content.csv';
  var document = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument();
  var directory = path.dirname(document.path);
  var page = document.selectedPage;
  console.log("page.name");
  console.log(page.name);
  var csvData = _skpm_fs__WEBPACK_IMPORTED_MODULE_1___default.a.readFileSync(directory + "/" + contentFileName);
  csv({
    noheader: false // output: "csv"

  }).fromString(csvData.toString()).subscribe(function (json, lineNumber) {
    console.log(lineNumber); // console.log(json)

    console.log(json['key']);
    var key = json['key'].split(".")[0]; // key = key.split(".")[0]
    // console.log(key)

    var layers = document.getLayersNamed(key);
      ...
      try {
        for (var _iterator = layers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (parentPage.name == page.name) {
            console.log("Layer is on current page"); // console.log(layer.type)

            if (layer.type === String(sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Types.SymbolInstance)) {
              console.log("Symbol layer"); // updateSymbol(layer, key, value)

              updateSymbol(layer, json['key'], json['zh_cn']);
            }

            if (layer.type === String(sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Types.Text)) {
              console.log("Text layer");
              layer.text = json['zh_cn'];
            }
          } else {// console.log("Layer not on current page")
          }
        }
      } catch (err) {
...
function updateSymbol(layer, key, value) {
  console.log("updateSymbol"); // console.log(layer.name)
  // console.log(key)
  // console.log(value)
  ...
  try {
    for (var _iterator2 = layer.overrides[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var override = _step2.value;

      if (override.property == "stringValue") {
        // console.log(override)
        var layerNameAndOverride = layer.name + "." + override.affectedLayer.name; // console.log(layerNameAndOverride)

        if (layerNameAndOverride == key) {
  ...
  console.log("updateSymbol done");
}

function getParentPage(layer) {
  var parent = layer.parent;

  if (parent.type === String(sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Types.Page)) {
    return parent;
  } else {

...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/create-content-file.js");
/******/ })
/************************************************************************/
/******/ ({
...
var path = __webpack_require__(/*! path */ "path"); // const csv = require('csvtojson')
...
var document = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument(); // const page = document.selectedPage

var directory = path.dirname(document.path); // const contentFileName = 'content.csv'

/* harmony default export */ __webpack_exports__["default"] = (function () {
  var userInput = document.askForUserInput_initialValue("Title", "default");
  log(userInput);
  ...
  if (document.pages) {
    ...
    try {
      for (var _iterator = document.pages[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (page.name != "Symbols") {
          ...
          try {
            for (var _iterator2 = page.layers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function getLayers(layer) {
  if (layer.layers) {
    ...
    if (layer.type === String(sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Types.SymbolInstance)) {
      ...
      try {
        for (var _iterator4 = layer.overrides[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var override = _step4.value;

          // console.log("override:")
          // console.log(override)
          if (override.property == "stringValue") {
            // console.log("affectedLayer: ")
...
//# sourceMappingURL=create-content-file.js.map